    ...
    <div class="row">
        <div class="col-4">
            <div class="list-group" id="list-tab" role="tablist">
                ...
                <a class="list-group-item list-group-item-action" id="list-messages-list" data-toggle="list"
                   href="#list-event" role="tab" aria-controls="messages">Eventos</a>
                <a class="list-group-item list-group-item-action" id="list-label-place-event" data-toggle="list"
                   href="#list-place-event" role="tab" aria-controls="profile">Lugar de evento</a>
                <a class="list-group-item list-group-item-action" id="list-calendar-label" data-toggle="list"
                   href="#list-calendar" role="tab" aria-controls="asd">Calendario</a>
                <a class="list-group-item list-group-item-action" id="list-label-event-area" data-toggle="list"
                   href="#list-eventArea" role="tab" aria-controls="messages">Asientos</a>
        ...
        <div class="col-8">
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade show active" id="list-artist" role="tabpanel"
                ...
                <div class="tab-pane fade" id="list-place-event" role="tabpanel"
                     aria-labelledby="list-label-place-event">
                ...
                <div class="tab-pane fade" id="list-eventArea" role="tabpanel" aria-labelledby="list-label-event-area">
                    <h2><a href="<?= FRONT_VIEW ?>/eventArea/">Secciones de evento</a></h2>
                    <p>crud de event Area</p>
                </div>
