...
<div class="row">
  ...
  <div class="col-8">
    <div class="tab-content" id="nav-tabContent">
      <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list"><h2><a href="<?= FRONT_VIEW ?>/artist/">Artistas</a></h2></div>
      <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list"><h2><a href="<?= FRONT_VIEW ?>/category/">Categorias</a></h2></div>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list"><h2><a href="<?= FRONT_VIEW ?>/default/">Tipo de area(tipo plaza) palco,platea</a></h2></div>
