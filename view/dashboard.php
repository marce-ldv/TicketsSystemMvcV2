    ...
    <div class="col-8">
      <div class="tab-content" id="nav-tabContent">
        ...
        <div class="tab-pane fade" id="list-type-area" role="tabpanel" aria-labelledby="list-settings-list">
         ...
         <div class="tab-pane fade" id="list-place-event" role="tabpanel" aria-labelledby="list-label-place-event"><h2><a href="<?= FRONT_VIEW ?>/placeEvent/">Tipo de place event(Lugar de evento) capacidad 95000 personas, Estadio libertadores de america por ejemplo</a></h2></div>
         <div class="tab-pane fade" id="list-calendar" role="tabpanel" aria-labelledby="list-calendar-label"><h2><a href="<?= FRONT_VIEW ?>/calendar/">Calendario</a></h2></div>
