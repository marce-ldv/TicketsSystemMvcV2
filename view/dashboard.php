...
<div class="row">
  ...
  <div class="col-8">
    <div class="tab-content" id="nav-tabContent">
      ...
      <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list"><h2><a href="<?= VIEW_URL ?>/category/">Categorias</a></h2></div>
      <div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list"><h2><a href="<?= VIEW_URL ?>/event/">Eventos</a></h2></div>
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list"><h2><a href="<?= VIEW_URL ?>/purchase/">Compras</a></h2></div>
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list"><h2><a href="<?= VIEW_URL ?>/default/">Tipo de area(tipo plaza) palco,platea</a></h2></div>
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list"><h2><a href="<?= VIEW_URL ?>/default/">Tipo de place event(Lugar de evento) capacidad 95000 personas, Estadio libertadores de america por ejemplo</a></h2></div>
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list"><h2><a href="<?= VIEW_URL ?>/eventArea/">Tipo de event area(asientos)</a></h2></div>
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list"><h2><a href="<?= VIEW_URL ?>/calendar/">Calendario</a></h2></div>
